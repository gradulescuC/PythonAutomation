...
def before_all(context):
    context.browser=webdriver.Chrome("/Users/gradulescu/Desktop/Personal/Cursuri/ITF/Automation Course/Proiecte Python/RepositoryGithub/PythonAutomation/selenium_workshop_pom/resources/chromedriver")
